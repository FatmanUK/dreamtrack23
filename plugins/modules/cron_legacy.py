...
def main():
    ...
    #
    # - cron_legacy: name="check dirs" hour="5,2" job="ls -alh > /dev/null"
    #
    # - name: do the job
    #   cron_legacy: name="do the job" hour="5,2" job="/some/dir/job.sh"
    #
    # - name: no job
    #   cron_legacy: name="an old job" state=absent
    #
    # - name: sets env
    #   cron_legacy: name="PATH" env=yes value="/bin:/usr/bin"
    #
    # Would produce:
    # PATH=/bin:/usr/bin
    # # Ansible: check dirs
